import { N as NOOP_MIDDLEWARE_HEADER, R as REDIRECT_STATUS_CODES, A as AstroError, b as ActionsReturnedInvalidDataError, D as DEFAULT_404_COMPONENT } from './astro/server_BA1NGprv.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { _: process.env._, W: process.env.W })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { _: process.env._, W: process.env.W })?.PROD) {
